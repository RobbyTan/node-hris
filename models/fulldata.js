...
let fulldataSchema = new mongoose.Schema({
  ...
  nama_gelar_sma: String,
  nama_gelar_d1: String,
  nama_gelar_d2: String,
  nama_gelar_d3: String,
  nama_gelar_d4: String,
  nama_gelar_s1: String,
  nama_gelar_s2: String,
  nama_gelar_s3: String,
  nama_institusi_pendidikan_sma: String,
  nama_institusi_pendidikan_d1: String,
  nama_institusi_pendidikan_d2: String,
  nama_institusi_pendidikan_d3: String,
  nama_institusi_pendidikan_d4: String,
  nama_institusi_pendidikan_s1: String,
  nama_institusi_pendidikan_s2: String,
  nama_institusi_pendidikan_s3: String,
  tanggal_tamat: Date,
  npwp: String,
  nama_pajak: String,
  alamat_pajak: String,
...
module.exports = mongoose.model('Fulldata', fulldataSchema)
